...
``core/fixtures/master_seed.json``.
...
DEFAULT_INPUT = Path("core/fixtures/master_seed.json")


# Deletion order — children first. Reverse of the load order in data_dump.SEED_MODELS.
